            ...
            if (in_array('holiday', $calendar_filter_array)) {
                ...
                foreach ($holidays as $holiday) {
                    $eventData[] = [
                        ...
                        'end' => $holiday->date,
                        'event_type' => 'holiday',
                        'extendedProps' => ['bg_color' => '$purple', 'color' => '#fff', 'icon' => 'fa-star']
                    ];
                }
            }
            ...
            if (in_array('tickets', $calendar_filter_array)) {
                ...
                foreach ($tickets as $ticket) {
                    $eventData[] = [
                        ...
                        'event_type' => 'ticket',
                        'extendedProps' => ['bg_color' => '$purple', 'color' => '#fff', 'icon' => 'fa-ticket-alt']
                    ];
                }
            }
            ...
            if (in_array('follow_ups', $calendar_filter_array)) {
                ...
                foreach ($followUps as $followUp) {
                    $eventData[] = [
                        ...
                        'extendedProps' => ['bg_color' => '$purple', 'color' => '#fff', 'icon' => 'fa-thumbs-up']
                    ];
                }
            }
