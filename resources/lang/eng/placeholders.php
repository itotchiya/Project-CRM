...
return array(
    ...
    'paymentGateway' => array(
        'sandboxPaypalClientId' => 'e.g. YOUR_SANDBOX_PAYPAL_CLIENT_ID',
        'livePaypalClientId' => 'e.g. YOUR_LIVE_PAYPAL_CLIENT_ID',
        'testStripePublishableKey' => 'e.g. YOUR_TEST_STRIPE_KEY',
        'liveStripePublishableKey' => 'e.g. YOUR_LIVE_STRIPE_KEY',
        'testRazorpayKey' => 'e.g. YOUR_TEST_RAZORPAY_KEY',
        'liveRazorpayKey' => 'e.g. YOUR_LIVE_RAZORPAY_KEY',
        'paystackKey' => 'e.g. YOUR_PAYSTACK_KEY',
        'flutterwaveKey' => 'e.g. YOUR_FLUTTERWAVE_KEY',
    ),
    'bankaccount' => array(
